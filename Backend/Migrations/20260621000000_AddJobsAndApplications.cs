...
namespace Backend.Migrations
{
    public partial class AddJobsAndApplications : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredSkills = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequiredCGPA = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Package = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_StudentId_JobId",
                table: "JobApplications",
